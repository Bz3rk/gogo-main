...
from .views import bookingReceipt, createBooking, junctionList, priceTableList, bookRide, rideSummary, userRideList, driverCars, activeCars
...
urlpatterns = [
    ...
    path('active-car', activeCars, name = ' activeCars'),
]